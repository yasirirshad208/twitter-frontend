    ...
    <div className="relative">
      ...
      >
        ...
        >
          ...
          <div>
          <button className="px-2 py-1 bg-blue-500 text-white rounded text-[14px]" onClick={()=>navigate('/admin/add/suggested-article')}>
                        Add Article
                      </button>
          </div>
          </div>
              ...
              <div className="flex items-center justify-between bg-[#f8f9fb] text-[13px] leading-[20px] font-[500] text-[#627183] px-3 py-4 rounded-[5px]">
                ...
                {categories.map((category, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1 px-3">{new Date(category.date).toLocaleDateString("en-GB", {
  day: "2-digit",
  month: "short",
  year: "numeric",
})}</div>
                    <div className="flex-1 px-3">{category.showAtHeader?"Yes":"No"}</div>
                    ...
                    <div className="flex-1 px-3">
                      <button className="px-2 py-1 bg-blue-500 text-white rounded" onClick={()=>navigate('/admin/update/suggested-article', {state:{id:category._id}})}>
                        Update
                      </button>
                    </div>
                  </div>
